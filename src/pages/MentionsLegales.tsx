    ...
    <section className="section-padding bg-white">
      <div className="container-custom">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-playfair mb-8">Mentions légales</h1>
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            <div>
              ...
              <p className="text-muted-foreground">
                ...
                <strong>Alcarys</strong><br />
                Services d'aide à domicile<br />
                Neuilly-sur-Marne, 93330<br />
                Seine-Saint-Denis, France<br /><br />
                Téléphone : 01 00 00 00 00<br />
                Email : contact@alcarys.fr
              </p>
            </div>

            <div>
              <h2 className="text-2xl font-playfair mb-4">2. Directeur de la publication</h2>
              <p className="text-muted-foreground">
            ...
            <div>
              <h2 className="text-2xl font-playfair mb-4">3. Hébergement</h2>
              <p className="text-muted-foreground">
            ...
            <div>
              <h2 className="text-2xl font-playfair mb-4">4. Propriété intellectuelle</h2>
              <p className="text-muted-foreground">
            ...
            <div>
              <h2 className="text-2xl font-playfair mb-4">5. Données personnelles</h2>
              <p className="text-muted-foreground">
